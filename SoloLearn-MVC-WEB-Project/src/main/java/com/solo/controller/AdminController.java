...
import com.solo.formdata.FreeContentForm;
...
public class AdminController {
	...
	public String processContent(@ModelAttribute("freeContent") FreeContentForm content,
		...
		try {
			...
			//freecontentform to freecontent
			
			FreeContent contentdata = FreeContent.builder().title(content.getTitle())
															.content(content.getContent())
															.pic(content.getPic())
															.date(content.getDate())
															.name1(content.getName1())
															.link1(content.getLink1())
															.name2(content.getName2())
															.link2(content.getLink2())
															.name3(content.getName3())
															.link3(content.getLink3())
															.build();

			contentService.saveContent(contentdata);// save Contents
